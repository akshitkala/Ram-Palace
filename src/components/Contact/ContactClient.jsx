...
function ContactForm() {
  ...
  return (
    <div className="w-full max-w-3xl p-8 md:p-12 rounded-3xl shadow-2xl border border-white/10 backdrop-blur-xl bg-white/5 animate-fade-in-up delay-100">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-white/80 text-xs uppercase tracking-widest mb-3 font-medium ml-1">Estimated Guests</label>
            <input 
              type="number" 
              name="guestCount"
        ...
        <div>
          <label className="block text-white/80 text-xs uppercase tracking-widest mb-3 font-medium ml-1">Your Requirements</label>
          <textarea 
            name="message"
            value={formData.message}
            onChange={handleChange}
            rows="4"
            className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-4 text-white placeholder-white/30 focus:outline-none focus:border-[#C9A84C]/50 focus:bg-white/10 transition-all duration-300 backdrop-blur-sm resize-none"
